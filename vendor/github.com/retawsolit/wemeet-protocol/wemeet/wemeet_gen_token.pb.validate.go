...
// Validate checks the field values on WeMeetTokenClaims with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
...
// WeMeetTokenClaimsMultiError is an error wrapping multiple validation errors
// returned by WeMeetTokenClaims.ValidateAll() if the designated constraints
// aren't met.
